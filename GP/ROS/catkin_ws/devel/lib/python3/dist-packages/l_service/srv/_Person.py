...
"""autogenerated by genpy from l_service/PersonRequest.msg. Do not edit."""
import codecs
import sys
...
class PersonRequest(genpy.Message):
  _md5sum = "21f83bfd0c41d3848cb08b07978b2e7e"
  _type = "l_service/PersonRequest"
...
def _get_struct_2B():
    ...
    return _struct_2B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from l_service/PersonResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class PersonResponse(genpy.Message):
  ...
  _type = "l_service/PersonResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# response
string result
...
def _get_struct_I():
    ...
    return _struct_I
class Person(object):
  _type          = 'l_service/Person'
  _md5sum = '9495c620750744a2177d2501849849d0'
