...
(cl:defmethod cl:initialize-instance :after ((m <Person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_pkg-msg:<Person> is deprecated: use test_pkg-msg:Person instead.")))
...
(cl:defmethod sex-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_pkg-msg:sex-val is deprecated.  Use test_pkg-msg:sex instead.")
  (sex m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_pkg-msg:age-val is deprecated.  Use test_pkg-msg:age instead.")
  (age m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Person>)))
  ...
  "9c69d4cca8265e8579c3162e701f97d6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Person)))
  "Returns md5sum for a message object of type 'Person"
  "9c69d4cca8265e8579c3162e701f97d6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Person>)))
  ...
  (cl:format cl:nil "string name~%uint8 sex~%uint8 age~%~%uint8 unkown = 0~%uint8 male = 1~%uint8 female = 2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Person)))
  "Returns full string definition for message of type 'Person"
  (cl:format cl:nil "string name~%uint8 sex~%uint8 age~%~%uint8 unkown = 0~%uint8 male = 1~%uint8 female = 2~%~%~%"))
