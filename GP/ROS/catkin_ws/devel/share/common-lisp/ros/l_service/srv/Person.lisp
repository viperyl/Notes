...
(cl:defmethod cl:initialize-instance :after ((m <Person-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name l_service-srv:<Person-request> is deprecated: use l_service-srv:Person-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Person-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader l_service-srv:name-val is deprecated.  Use l_service-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Person-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader l_service-srv:age-val is deprecated.  Use l_service-srv:age instead.")
  (age m))

(cl:ensure-generic-function 'sex-val :lambda-list '(m))
(cl:defmethod sex-val ((m <Person-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader l_service-srv:sex-val is deprecated.  Use l_service-srv:sex instead.")
  (sex m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Person-request>)))
  ...
  "9495c620750744a2177d2501849849d0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Person-request)))
  "Returns md5sum for a message object of type 'Person-request"
  "9495c620750744a2177d2501849849d0")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Person-request>)))
  ...
  (cl:format cl:nil "string name~%uint8 age~%uint8 sex~%# request~%uint8 unknown = 0~%uint8 male = 1~%uint8 feamle = 2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Person-request)))
  "Returns full string definition for message of type 'Person-request"
  (cl:format cl:nil "string name~%uint8 age~%uint8 sex~%# request~%uint8 unknown = 0~%uint8 male = 1~%uint8 feamle = 2~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <Person-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name l_service-srv:<Person-response> is deprecated: use l_service-srv:Person-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <Person-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader l_service-srv:result-val is deprecated.  Use l_service-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Person-response>)))
  ...
  (cl:format cl:nil "# response~%string result~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Person-response)))
  "Returns full string definition for message of type 'Person-response"
  (cl:format cl:nil "# response~%string result~%~%~%~%"))
